    ...
    <AppLayout :breadcrumbs="[{ label: 'Website' }, { label: 'Faculty' }]">
        <div class="space-y-5">
            <div class="flex items-start justify-between gap-4 flex-wrap">
                <div>
                    <h1 class="text-2xl font-bold">Faculty Members</h1>
                    <p class="text-sm text-base-content/60 mt-1">
                        Teachers and staff displayed on the public Faculty page.
                    </p>
                </div>
                <Link :href="route('website.faculty.create')" class="btn btn-primary btn-sm gap-2">
            ...
            <template v-else>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div v-for="m in members.data" :key="m.id"
                        class="card bg-base-100 shadow-sm border border-base-200 hover:shadow-md hover:border-primary/30 transition-all">
                        <div class="card-body p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p v-if="m.department" class="text-[11px] text-emerald-700 font-semibold mt-1 inline-flex items-center gap-1">
