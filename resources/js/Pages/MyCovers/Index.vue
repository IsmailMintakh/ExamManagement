...
function declineCover(row) {
    if (!confirm('Decline this cover? Admin will be notified and they will reassign it.')) return
    router.post(route('my-covers.decline', row.id), {}, { preserveScroll: true })
}
...
<template>
    <Head title="My Cover Duties" />
    <AppLayout :breadcrumbs="[{ label: 'My Cover Duties' }]">
        <div class="space-y-5 max-w-5xl mx-auto">
            ...
            <div>
                ...
                <p class="text-sm text-base-content/55 mt-1">
                    Substitution periods you've been assigned. Today's covers are at the top.
                </p>
            </div>
            ...
            <section class="rounded-2xl border-2 border-amber-500/30 bg-amber-500/5 overflow-hidden">
                ...
                <div v-else class="px-5 py-8 text-center">
                    ...
                    <p class="font-bold text-sm">No covers today!</p>
                </div>
            </section>
